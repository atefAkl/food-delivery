        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('frontend.contact') ? 'active' : '' }}" href="{{ route('frontend.contact') }}">اتصل بنا</a>
                    </li>
                </ul>
                    ...
                    @auth
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                @if(Auth::user()->type === 'chef')
                                    <li><a class="dropdown-item" href="{{ route('frontend.chef.dashboard') }}">لوحة التحكم</a></li>
                                    <li><a class="dropdown-item" href="{{ route('frontend.chef.dishes') }}">أطباقي</a></li>
                                    <li><a class="dropdown-item" href="{{ route('frontend.chef.orders') }}">الطلبات</a></li>
                                    <li><a class="dropdown-item" href="{{ route('frontend.chef.earnings') }}">الأرباح</a></li>
                                @elseif(Auth::user()->type === 'customer')
                                    <li><a class="dropdown-item" href="{{ route('frontend.customer.dashboard') }}">لوحة التحكم</a></li>
                                    <li><a class="dropdown-item" href="{{ route('frontend.cart') }}">سلة التسوق</a></li>
                                    <li><a class="dropdown-item" href="{{ route('frontend.customer.orders') }}">طلباتي</a></li>
                                    <li><a class="dropdown-item" href="{{ route('frontend.favorites') }}">المفضلة</a></li>
                                @endif
                                <li><a class="dropdown-item" href="{{ route('frontend.profile') }}">الملف الشخصي</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ route('frontend.contact') }}" class="text-white">اتصل بنا</a></li>
                    </ul>
                </div>
                <div class="col-md-4 mb-4">
                    <h5>تواصل معنا</h5>
