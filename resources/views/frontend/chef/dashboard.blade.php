...
<div class="row">
    ...
    <div class="col-lg-9">
        ...
        <div class="row mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="mb-0 mt-2">{{ $dishesCount }}</h2>
                            </div>
                            <i class="fas fa-utensils fa-2x"></i>
                        </div>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a href="{{ route('frontend.chef.dishes') }}" class="text-white text-decoration-none small">عرض التفاصيل</a>
            ...
            <div class="col-md-3 mb-3">
                <div class="card bg-success text-white h-100">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a href="{{ route('frontend.chef.orders') }}" class="text-white text-decoration-none small">عرض التفاصيل</a>
                        <i class="fas fa-angle-left text-white"></i>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="mb-0 mt-2">{{ $ratingsCount }}</h2>
                            </div>
                            <i class="fas fa-star fa-2x"></i>
                        </div>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a href="{{ route('frontend.chef.ratings') }}" class="text-white text-decoration-none small">عرض التفاصيل</a>
                        <i class="fas fa-angle-left text-white"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card bg-warning text-dark h-100">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a href="{{ route('frontend.chef.earnings') }}" class="text-dark text-decoration-none small">عرض التفاصيل</a>
            ...
            <div class="col-md-7 mb-4">
                <div class="card shadow-sm h-100">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('frontend.chef.orders') }}" class="btn btn-sm btn-outline-primary">عرض الكل</a>
                    </div>
                    <div class="card-body">
                        ...
                        @if(count($recentRatings) > 0)
                            @foreach($recentRatings as $rating)
                                <div class="d-flex mb-3">
                                    ...
                                    <div>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class="mb-0">{{ $rating->customer->user->name }}</h6>
            ...
            <div class="col-md-12 mb-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('frontend.chef.dishes') }}" class="btn btn-sm btn-outline-primary">عرض كل الأطباق</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card h-100">
                                            ...
                                            <div class="card-footer bg-white">
                                                <a href="{{ route('frontend.chef.dishes.edit', $dish->id) }}" class="btn btn-sm btn-outline-primary w-100">تعديل</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-3">
            <a href="{{ route('frontend.chef.dishes.create') }}" class="btn btn-primary btn-lg">
